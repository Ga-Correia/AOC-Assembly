.data
	...
	msgSenha: .asciiz "Insira a senha: "
	msgSenhaIncorreta: .asciiz "Senha incorreta."
...
.text
	...
	Impressao:
	  ...
	  la $a0, msgSenha      
          ...
          beq $v0, 193224 whileDescripto
          li $v0, 4 
	  la $a0, msgSenhaIncorreta     
          syscall
	...
	whileDescripto:
	  lb  $t4, ($t0)
          beq $t4, $zero, Finalizacao
          
          beq $t4, 48 DescTrocaZeroporO
          beq $t4, 49 DescTroca1porI
          beq $t4, 50 DescTroca2porZ
          beq $t4, 51 DescTroca3porE
          beq $t4, 52 DescTroca4porA
          beq $t4, 53 DescTroca5porS
          beq $t4, 54 DescTroca6porG
          beq $t4, 55 DescTroca7porT
          beq $t4, 56 DescTroca8porB
          beq $t4, 57 DescTroca9porP
          
          beq $t4, 79 DescTrocaOporZero 
          beq $t4, 73 DescTrocaIpor1
          beq $t4, 90 DescTrocaZpor2
          beq $t4, 69 DescTrocaEpor3
          beq $t4, 65 DescTrocaApor4
          beq $t4, 83 DescTrocaSpor5
          beq $t4, 71 DescTrocaGpor6
          beq $t4, 84 DescTrocaTpor7
          beq $t4, 66 DescTrocaBpor8
          beq $t4, 80 DescTrocaPpor9
